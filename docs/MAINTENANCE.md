...
**当前进度（2026-09-04）：已收 90 篇 / arXiv 召回 253 篇，覆盖率约 36%。**
19 个小节全部有内容。年份分布 2025: 25 / 2026: 65。
...
| 方向 | 说明 |
|---|---|
| §3.3 Mobile 基准（2 篇） | 相对最薄，候选里有 FedGUI、LabOSBench 等 |
| §3.4 Desktop 基准（1 篇） | 同上，OS-SPEAR 等待整理 |
